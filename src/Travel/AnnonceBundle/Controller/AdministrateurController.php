...
use Travel\AnnonceBundle\Entity\Administrateur;
use Travel\AnnonceBundle\Form\AdministrateurType;
...
class AdministrateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TravelAnnonceBundle:Administrateur')->findAll();
     ...
     * @Method("POST")
     * @Template("TravelAnnonceBundle:Administrateur:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TravelAnnonceBundle:Administrateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TravelAnnonceBundle:Administrateur:edit.html.twig")
     */
