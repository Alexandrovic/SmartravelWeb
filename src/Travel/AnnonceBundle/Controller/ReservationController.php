...
use Travel\AnnonceBundle\Entity\Reservation;
use Travel\AnnonceBundle\Form\ReservationType;
...
class ReservationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TravelAnnonceBundle:Reservation')->findAll();
     ...
     * @Method("POST")
     * @Template("TravelAnnonceBundle:Reservation:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TravelAnnonceBundle:Reservation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TravelAnnonceBundle:Reservation:edit.html.twig")
     */
