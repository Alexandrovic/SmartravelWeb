...
use Travel\AnnonceBundle\Entity\Voyage;
use Travel\AnnonceBundle\Form\VoyageType;
...
class VoyageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TravelAnnonceBundle:Voyage')->findAll();
     ...
     *
     * @Route("/", name="voyage_create")
     * @Method("POST")
     * @Template("TravelAnnonceBundle:Voyage:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TravelAnnonceBundle:Voyage')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TravelAnnonceBundle:Voyage:edit.html.twig")
     */
